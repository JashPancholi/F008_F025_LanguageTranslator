...
button1 = Button(window,text='Translate', bg = 'Red',command=translate_function).place(x=160,y=190)
button2 = Button(window,text='Clear', bg = 'Red',command=clear).place(x=270,y=190)
#close the app
window.mainloop()
